    ...
    return Container(
      ...
      child: Row(children: [
        ResponsiveBuilder(builder: (context, sizingInformation) {
          ...
          if ((showMore ?? false) || sizingInformation.deviceScreenType != DeviceScreenType.desktop) {
            return InkWell(
              child: Container(
          ...
          child: Stack(
            ...
            children: [
              Container(
                  ...
                  height: 34,
                  alignment: Alignment.center,
                  decoration: const BoxDecoration(color: FlarelineColors.background, shape: BoxShape.circle),
                  child: SvgPicture.asset('assets/toolbar/alarm.svg', width: 18, height: 18)),
              const Align(
                child: AnimBadge(),
              )
            ],
          ...
          child: Stack(
            ...
            children: [
              Container(
                  ...
                  alignment: Alignment.center,
                  decoration: const BoxDecoration(color: FlarelineColors.background, shape: BoxShape.circle),
                  child: SvgPicture.asset('assets/toolbar/message.svg', width: 18, height: 18)),
              const Align(
                child: AnimBadge(),
              )
            ],
        ...
        InkWell(
          ...
          onTap: () async {
            await showMenu(
              color: Colors.white,
              context: context,
              position: RelativeRect.fromLTRB(MediaQuery.of(context).size.width - 100, 80, 0, 0),
              items: <PopupMenuItem<String>>[
                ...
                PopupMenuItem<String>(enabled: false, value: 'value04', child: _languagesWidget(context)),
                PopupMenuItem<String>(
                  value: 'value05',
                  child: Text('Log out'),
                  onTap: () {
    ...
    return Wrap(
      ...
      children: context.read<LocalizationProvider>().supportedLocales.map((e) {
        return SizedBox(
          width: 50,
          height: 20,
          child: Consumer<LocalizationProvider>(builder: (ctx, provider, child) {
            return ButtonWidget(
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      child: Container(
          ...
          decoration: BoxDecoration(color: FlarelineColors.background, borderRadius: BorderRadius.circular(45)),
          child: Row(
            ...
            children: [
              CircleAvatar(
                ...
                child: SvgPicture.asset('assets/toolbar/sun.svg', width: 18, height: 18, color: isDark ? FlarelineColors.darkTextBody : FlarelineColors.primary),
              ),
              CircleAvatar(
                radius: 15,
                backgroundColor: isDark ? Colors.white : Colors.transparent,
                child: SvgPicture.asset('assets/toolbar/moon.svg', width: 18, height: 18, color: isDark ? FlarelineColors.primary : FlarelineColors.darkTextBody),
              ),
            ],
          )),
      onTap: () {
