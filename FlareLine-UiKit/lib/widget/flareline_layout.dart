...
abstract class FlarelineLayoutWidget extends StatelessWidget {
  ...
  String get appName => 'Where\'s my money?!';
  ...
  EdgeInsetsGeometry? get padding => const EdgeInsets.symmetric(horizontal: 20, vertical: 16);
      ...
      body: ResponsiveBuilder(
        builder: (context, sizingInformation) {
          ...
          if (sizingInformation.deviceScreenType == DeviceScreenType.desktop) {
            return Row(
              children: [if (showSideBar) sideBarWidget(context), Expanded(child: rightContentWidget(context))],
            );
          }
  ...
  Widget rightContentWidget(BuildContext context) {
    ...
    return Column(children: [
      if (showToolBar)
        toolbarWidget(context, showDrawer,) ?? const SizedBox.shrink(),
      if (showToolBar)
      ...
      Expanded(
        ...
        padding: padding,
        child: isContentScroll ? SingleChildScrollView(child: contentWidget) : contentWidget,
      ))
    ]);
  }
}
